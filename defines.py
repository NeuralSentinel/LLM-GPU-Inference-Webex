...
SOURCE_DIRECTORY = f"RAW_DATA"

PERSIST_DIRECTORY = f"PROCESSED_DATA/DB"
...
EMBEDDING_MODEL_NAME = 'sentence-transformers/all-MiniLM-L6-v2'#"BAAI/bge-large-en" #"hkunlp/instructor-large"
